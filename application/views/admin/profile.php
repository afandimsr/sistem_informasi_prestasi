...
<head>
  ...
  <title>Sistem Prestasi Terpadu EneRC | User Profile</title>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?= base_url('admin/tabel_punggawa')?>"><i class="fa fa-circle-o"></i> Tabel Punggawa</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="<?= base_url('admin/form_punggawa')?>"><i class="fa fa-circle-o"></i> Tambah Data Punggawa</a></li>
          </ul>
        </li>
